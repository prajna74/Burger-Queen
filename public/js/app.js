...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (order.status == dataProp) {
      timee.innerText = moment__WEBPACK_IMPORTED_MODULE_3___default()(order.updatedAt).format("hh:mm A");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkburger"] = self["webpackChunkburger"] || [];
